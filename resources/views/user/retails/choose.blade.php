...
@section('content')
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">بنکداری /</span></h4>

    <div class="container" bis_skin_checked="1">

        <div class="row" bis_skin_checked="1">
            <div class="col-lg-10 mx-auto" bis_skin_checked="1">
                <div class="row g-6" bis_skin_checked="1">
                    <div class="col-xl-4 col-md-6" bis_skin_checked="1">
                        <div class="card border shadow-none" bis_skin_checked="1">
                            <div class="card-body text-center" bis_skin_checked="1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="58" height="58" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-photo-star">
                                ...
                                <h5 class="my-3">گالری عکس</h5>
                                <p class="mb-3">گالری عکس بخشی از نرم‌افزار طلافروشی برای نمایش تصاویر محصولات است.</p>
                                <a class="btn btn-sm btn-label-primary waves-effect" href="{{route('user.categories.index')}}">
                    ...
                    <div class="col-xl-4 col-md-6" bis_skin_checked="1">
                        <div class="card border shadow-none" bis_skin_checked="1">
                            <div class="card-body text-center" bis_skin_checked="1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="58" height="58" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-receipt">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                    <path d="M5 21v-16a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2v16l-3 -2l-2 2l-2 -2l-2 2l-2 -2l-3 2m4 -14h6m-6 4h6m-2 4h2" />
                                </svg>
    
                                <h5 class="my-3">سفارش</h5>
                                <p class="mb-3">سفارش بخشی از نرم‌افزار طلافروشی برای ثبت و پیگیری خرید محصولات است.</p>
                                <a class="btn btn-sm btn-label-primary waves-effect" href="{{route('panel.user.retails.categories')}}">
                                    <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-arrow-narrow-right"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 12l14 0" /><path d="M15 16l4 -4" /><path d="M15 8l4 4" /></svg>
                                </a>
                            </div>
                        </div>
