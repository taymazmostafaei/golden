...
@section('title', 'سفارشات بنک داری')
...
@section('page-script')
    <script>
        var OrdersRetailJsonPath = "{{ route('orders.retail.json') }}";
        $('#paymentMethods').on('show.bs.modal', function(e) {

            let clickedID = $(e.relatedTarget).attr('data-id') * 1;
            Livewire.dispatch('UpdateOrderDetailModal', {
                RetailOrder: clickedID
            });
        });
    </script>
    <script src="{{ asset('assets/js/orderLists-bonakDary.js') }}"></script>
@endsection

@section('content')

    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">لیست سفارش /</span> بنکداری
    </h4>
                ...
                <div class="row gy-4 gy-sm-1">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="d-flex justify-content-between align-items-start border-end pb-3 pb-sm-0 card-widget-3">
                            <div>
                                <h4 class="mb-2">{{ $last_week_orders }}</h4>
                                <p class="mb-0 fw-medium">سفارشات هفته</p>
                            </div>
                            <span class="avatar p-2 me-sm-4">
                                <span class="avatar-initial bg-label-secondary rounded"><i
                                        class="ti-md ti ti-calendar-stats text-body"></i></span>
                            </span>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                <h4 class="mb-2">{{ $last_month_orders }}</h4>
                                <p class="mb-0 fw-medium">سفارشات ماه</p>
                            </div>
        ...
        <div class="modal-dialog modal-lg modal-simple modal-enable-otp modal-dialog-centered">
            <div class="modal-content p-3 p-md-5">
                <div class="modal-body">
                    ...
                    <livewire:retail.orders-detail :is_admin="true"/>
                </div>
            </div>
        </div>
    </div>
