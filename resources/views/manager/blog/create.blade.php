  ...
  <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
    ...
    <div class="d-flex align-content-center flex-wrap gap-3">
      <div class="d-flex gap-3"><button class="btn btn-label-secondary">حذف</button>
        <button class="btn btn-label-primary">ذخیره پیش نویس</button></div>
    ...
    <div class="col-12 col-lg-8">
      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="ecommerce-product-name" placeholder="موضوع وبلاگ" name="productTitle" aria-label="Product title">
          </div>
          <div class="mb-3">
            <label class="form-label" for="ecommerce-product-name">توضیح کوتاه</label>
            <input type="text" class="form-control" id="ecommerce-product-name" placeholder="توضیح کوتاه اختیاری است" name="productTitle" aria-label="Product title">
          </div>
          <!-- Description -->
          <div>
      ...
      <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
          <h5 class="mb-0 card-title">عکس وبلاگ</h5>
        </div>
        <div class="card-body">
          <form action="/upload" class="dropzone needsclick" id="dropzone-basic">
            <div class="dz-message needsclick">
              ...
              <span class="note needsclick btn bg-label-primary d-inline" id="btnBrowse">تصویر را انتخاب کنید</span>
            </div>
            <div class="fallback">
      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          <div class="input-group mt-4">
            <button class="btn btn-outline-primary waves-effect" type="button" id="button-addon2">مشاهده مطلب</button>
            <input type="text" class="form-control" placeholder="آدرس مطلب" aria-label="Recipient's username" aria-describedby="button-addon2">
          </div>
        </div>
      </div>
      <!-- /امکانات Card -->
