                            ...
                            <div class="dz-preview dz-processing dz-image-preview dz-success dz-complete col-lg-6">
                                <div class="dz-details">
                                    <div class="dz-thumbnail">
                                        <img class="img-fluid mx-auto rounded" src="//localhost:3000/assets/img/elements/4.jpg" alt="Card image cap">
                                ...
                                </div><a class="dz-remove text-danger" href="javascript:undefined;" data-dz-remove=""><i class="ti ti-trash"></i></a>
                            </div>
                        </div>
