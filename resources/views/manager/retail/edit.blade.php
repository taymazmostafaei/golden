                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="ecommerce-product-name"
                                        placeholder="نام محصول بنکداری" name="name" value="{{$retail->name}}" aria-label="Product title">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="ecommerce-product-name"
                                        placeholder="به ریال وارد کنید" value="{{$retail->price}}" name="price" aria-label="Product title">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <select id="multicol-country" name="retail_category_id" class="select2 form-select" data-allow-clear="true">
                                        @foreach ($cats as $cat)
                                            <option @selected($cat->id == $retail->retail_category_id) value="{{$cat->id}}">{{$cat->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="d-flex justify-content-between align-items-center border-top pt-3">
                                    ...
                                    <div class="w-25 d-flex justify-content-end">
                                        <label class="switch switch-primary switch-sm me-4 pe-2">
                                            <input type="checkbox" class="switch-input" name="hide" @checked($retail->hide)>
