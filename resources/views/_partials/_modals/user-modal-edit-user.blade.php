          ...
          <form id="editUserForm" class="row g-3" onsubmit="return false">
            ...
            <div class="col-12 col-md-6">
              ...
              <div class="input-group">
                ...
                <input style="direction: ltr" type="text" id="modalEditUserPhone" name="modalEditUserPhone" class="form-control phone-number-mask" placeholder="202 555 0111" disabled />
